...
MIN_TRANSFER_AMOUNT = 0.01 # если amount будет меньше этого числа, выводить монету не будет
MIN_TRANSFER_USD    = 1 # в $, если amount * price будет меньше этого числа, выводить монету не будет
